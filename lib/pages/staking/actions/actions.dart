      ...
      return Container(
        ...
        child: ListTile(
          ...
          leading: Container(
            ...
            child: i.success
                ? SvgPicture.asset(
                    'packages/polkawallet_plugin_xxnetwork/assets/images/staking/ok.svg')
                : SvgPicture.asset(
                    'packages/polkawallet_plugin_xxnetwork/assets/images/staking/error.svg'),
          ),
          title: Text(dic[i.call] == null ? i.call : dic[i.call]),
        ...
        child: ListTile(
          ...
          leading: Container(
            ...
            child: SvgPicture.asset(
                'packages/polkawallet_plugin_xxnetwork/assets/images/staking/${isReward ? 'reward' : 'slash'}.svg'),
          ),
...
class StakingInfoPanel extends StatelessWidget {
  ...
  void _showUnlocking(BuildContext context) {
    final dic = I18n.of(context).getDic(i18n_full_dic_protonet, 'staking');
    final dicGov = I18n.of(context).getDic(i18n_full_dic_protonet, 'gov');
