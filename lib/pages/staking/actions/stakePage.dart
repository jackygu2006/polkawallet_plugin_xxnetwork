...
import 'package:polkawallet_plugin_xxnetwork/pages/staking/actions/bondPage.dart';
import 'package:polkawallet_plugin_xxnetwork/pages/staking/actions/nominateForm.dart';
...
class _StakePageState extends State<StakePage> {
  ...
  Future<void> _onStake(TxConfirmParams nominateParams) async {
    ...
    List<dynamic> params = _bondParams.params.sublist(0, 2);
    params.add(null); // cmixId default is null
