...
import 'package:polkawallet_plugin_xxnetwork/common/components/infoItem.dart';
...
class _CouncilState extends State<Council> {
  ...
  Future<void> _submitCancelVotes() async {
    final govDic = I18n.of(context).getDic(i18n_full_dic_protonet, 'gov');
      ...
      builder: (BuildContext context) {
        return CupertinoAlertDialog(
          ...
          content: Text(I18n.of(context)
              .getDic(i18n_full_dic_protonet, 'gov')['vote.remove.confirm']),
          actions: [
            CupertinoButton(
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      subtitle: balance.length == 1
          ? null
          : Text(
              '${I18n.of(context).getDic(i18n_full_dic_protonet, 'gov')['backing']}: ${Fmt.token(
