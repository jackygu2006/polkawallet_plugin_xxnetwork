...
import 'package:polkawallet_plugin_xxnetwork_example/pages/assetsContent.dart';
import 'package:polkawallet_plugin_xxnetwork_example/pages/homePage.dart';
import 'package:polkawallet_plugin_xxnetwork_example/pages/profileContent.dart';
import 'package:polkawallet_plugin_xxnetwork_example/pages/selectListPage.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      title: 'Polkawallet Plugin xxnetwork Demo',
